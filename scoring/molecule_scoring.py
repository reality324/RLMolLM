...
import re
import scipy.stats
from scoring.scoring_interface import ScoringInterface
...
class MoleculeScoring(ScoringInterface):
    ...
    def column_names(self):
        ...
        if self._scoring_admet_names is not None:
            all_names = [self._data_column_name] + list(self._scoring_names) + list(self._scoring_admet_names) + [self._fitness_column_name]
        else:
