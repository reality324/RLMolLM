...
def plot_property_umap(embedding, property_values, labels, title, property_name, cmap='viridis', invert=False, ax=None, vmin=None, vmax=None):
    ...
    gen_scatter = ax.scatter(
        ...
        marker='s', s=50, alpha=0.7, edgecolors='black', linewidth=0.5
    )
...
def main():
    ...
    # Define property configurations for plotting
    property_configs = [
        {
            "values": synth_scores,
            "name": "SA Score",
            ...
            "cmap": "viridis",
            "invert": True,  # Invert so darker = lower SA (more synthesizable)
            "filename": f"{args.output_dir}/umap_sa_score.png"
        },
        {
            "values": qed_scores,
            "name": "QED Score",
            ...
            "filename": f"{args.output_dir}/umap_qed.png"
        },
        {
            "values": logp_values,
            "name": "logP",
            ...
            "filename": f"{args.output_dir}/umap_logp.png"
        },
        {
            ...
            "filename": f"{args.output_dir}/umap_permeability.png"
        },
        {
            "values": atom_counts,
            ...
            "filename": f"{args.output_dir}/umap_atom_count.png"
        }
    ]
    ...
    if args.combined_figure:
        ...
        plt.tight_layout()
        plt.savefig(f"{args.output_dir}/umap_all_properties.png", dpi=300, bbox_inches='tight')
        plt.close()
