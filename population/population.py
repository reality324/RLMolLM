from scoring.molecule_scoring import MoleculeScoring
import numpy as np
import rdkit
import rdkit.Chem
import torch
from models.rl import PPOTrainer
...
class Population():
    ...
    def __init__(self, gan_operators, scoring_operator, use_scaffold=False, scaffold_handler=None, mask_mode="replace"):
